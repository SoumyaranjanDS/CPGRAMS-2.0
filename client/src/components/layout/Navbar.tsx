            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              ...
              {user ? (
                <div className="relative">
                  ...
                  {userDropdownOpen && (
                    <div
                      className="absolute right-0 mt-2 w-64 rounded-2xl bg-white border border-slate-200 shadow-2xl p-2 z-50 animate-in fade-in zoom-in-95 text-left space-y-2"
                ...
                <div className="flex items-center gap-1.5">
                  <button
                    ...
                    className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs lg:text-sm font-bold text-[#0A2540] hover:bg-slate-100 transition-colors cursor-pointer border border-slate-200 shadow-2xs whitespace-nowrap"
                  >
                  ...
                  <button
                    ...
                    className="hidden sm:inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs lg:text-sm font-bold text-[#6F0047] hover:bg-fuchsia-50 transition-colors cursor-pointer border border-[#6F0047]/20 shadow-2xs whitespace-nowrap"
                  >
                    <UserPlus className="w-4 h-4 text-[#6F0047]" />
                    <span>Register</span>
                  </button>
                </div>
              )}
              ...
              {!user ? (
                <div className="grid grid-cols-2 gap-2">
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full justify-center text-xs font-bold py-2.5 bg-white"
                    onClick={() => {
                      handleCloseMobileMenu();
                      navigate('/login');
                    }}
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full justify-center text-xs font-bold py-2.5 bg-white text-[#6F0047] border-[#6F0047]/30"
                    onClick={() => {
                      handleCloseMobileMenu();
                ...
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-white border border-slate-200 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <strong className="text-slate-900 font-bold block leading-tight">{user.name}</strong>
