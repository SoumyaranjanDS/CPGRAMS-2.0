...
const envSchema = z.object({
  ...
  JWT_SECRET: z.string().default('cpgrams_super_secret_jwt_access_key_2026_production'),
  JWT_EXPIRES_IN: z.string().default('15m'),
  JWT_REFRESH_SECRET: z.string().default('cpgrams_super_secret_jwt_refresh_key_2026_production'),
